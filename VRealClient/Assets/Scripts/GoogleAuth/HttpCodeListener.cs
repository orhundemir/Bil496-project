...
public class HttpCodeListener
{
    ...
    private const string responseHtml = "You have successfully authenticated with Google and received an access token. You can return to the app now!"; 
    ...
    private void ListenerCallback(IAsyncResult result)
    {
        ...
        MainThreadExecutor.Instance().Enqueue(() => onCodeFetched?.Invoke(context.Request.QueryString.Get("code")));
